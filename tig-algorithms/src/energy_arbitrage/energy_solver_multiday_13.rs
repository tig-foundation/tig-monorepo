// energy_solver_multiday_13: thresholds re-tuned at trend_factor=0.6364 operating point.
...
pub fn help() {
    ...
    println!();
    println!("Refines multiday_12 by re-tuning base thresholds at the new trend-aware operating point");
    println!("(trend_factor=0.6364). All other params at multiday_12 winners.");
}
