// energy_solver_multiday_10: thresholds refined at new operating point (lookahead=66, end_window=66). Includes lower dt values.
...
pub fn help() {
    ...
    println!("  discharge_threshold: float range=[0.5, 2.0] default=1.0   # $/MWh above DA-median to discharge");
    println!();
    println!("Refines multiday_9 by re-tuning thresholds at the new operating point (lookahead=66, end_window=66).");
    println!("end_factor=0.0, slope=1.273, profit_weight_power=2.545, lookahead=66, end_window=66 fixed.");
}
