...
pub fn help() {
    println!("energy_arbitrage 'prometheus' — DP-value-function MPC with a joint PTDF-projected");
    println!("gradient step and an active-line coordinate polish.");
    println!();
    println!("Hyperparameters (integers; defaults in parentheses):");
    println!("  dp_soc_levels (33)         DP value-function SOC grid resolution");
    println!("  dp_action_levels (17)      action grid used to build the DP");
    ...
    println!("  coord_polish_passes (1)    PTDF-aware coordinate-polish passes");
