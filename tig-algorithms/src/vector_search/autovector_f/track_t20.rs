...
pub fn solve(
    ...
    let conv_fn    = module.load_function("convert_fp32_to_fp16_padded_t20")?;
    let norms_fn   = module.load_function("compute_norms_fp16_t20")?;
    let rabit_fn   = module.load_function("encode_rabitq_flat_t20")?;
    let bf_gemm_fn = module.load_function("bruteforce_gemm_argmin_t20")?;
