...
pub fn solve(
    ...
    let norms_func  = module.load_function("compute_norms_t17")?;
    let conv_func   = module.load_function("convert_fp32_to_fp16_padded_t17")?;
    let chunk_func  = module.load_function("fused_wmma_chunk_search_t17")?;
    let reduce_func = module.load_function("reduce_chunk_bests_t17")?;
