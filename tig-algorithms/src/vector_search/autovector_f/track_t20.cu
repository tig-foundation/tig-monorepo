...
extern "C" __global__ void convert_fp32_to_fp16_padded_t20(
...
extern "C" __global__ void compute_norms_fp16_t20(
...
extern "C" __global__ void encode_rabitq_flat_t20(
...
extern "C" __global__ void bruteforce_gemm_argmin_t20(
