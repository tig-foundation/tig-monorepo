...
pub fn solve(
    ...
    let conv_fn    = module.load_function("convert_fp32_to_fp16_padded_t18")?;
    let norms_fn   = module.load_function("compute_norms_fp16_t18")?;
    let rabit_fn   = module.load_function("encode_rabitq_flat_t18")?;
    let bf_gemm_fn = module.load_function("bruteforce_gemm_argmin_t18")?;
