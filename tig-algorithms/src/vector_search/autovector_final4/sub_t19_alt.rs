...
pub fn solve_t19_alt(
    ...
    let norms_func = module.load_function("compute_norms_v122_alt")?;
    let find_func  = module.load_function("find_best_v122_alt")?;
...
pub fn help() {
    println!("AutoVector v122 — cuBLAS on TIG stream via CudaBlas::new(stream.clone())");
}
