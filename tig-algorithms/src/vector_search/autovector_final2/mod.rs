...
// Copyright (c) 2026 NVX — autovector_v18
use anyhow::Result;
...
pub fn solve_challenge(
    ...
    let search_func = module.load_function("search_v18")?;

    unsafe {
        search_func.set_attribute(
            CUfunction_attribute_enum::CU_FUNC_ATTRIBUTE_MAX_DYNAMIC_SHARED_SIZE_BYTES,
            DYNAMIC_SMEM as i32,
        )?;
    }

    let queries_per_block: u32 = 32;
