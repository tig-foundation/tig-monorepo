extern "C" __global__ __launch_bounds__(512, 4) void sign_ef_consensus_kernel_14(
...
extern "C" __global__ __launch_bounds__(512, 4) void dual_consensus_fisher_kernel_14(
    const float* __restrict__ gradients,
    const float* __restrict__ params,
