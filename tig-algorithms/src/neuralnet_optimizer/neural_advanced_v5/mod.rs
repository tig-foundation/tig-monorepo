...
pub fn help() {
    println!("Neural Advanced v5 - Dual-Phase Consensus Optimizer");
    println!("====================================================");
    println!("Further refined achieving higher qualities on n_hidden=4, n_hidden=7, n_hidden=10 and n_hidden=14");
