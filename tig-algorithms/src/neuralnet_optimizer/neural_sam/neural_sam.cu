// Robust kernel: sign + error-feedback + Fisher normalization
// Used for near-floor convergence / late phase
...
// Fast kernel: dual consensus with Fisher, Nesterov, Adam, norm, sign, ortho, BB
