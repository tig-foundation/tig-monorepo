...
mod inner {
    ...
    /* =========================================================
     * SECTION 1: Phase-1 instance (QKBP)
     * ========================================================= */
    ...
    /* =========================================================
     * SECTION 3: HPF parametric min-cut
     * ========================================================= */
    ...
    mod hpf {
        ...
        pub fn get_breakpoints(inst: &P1Instance, n_lambda_values: usize) -> BreakpointSets {
            ...
            unsafe {
                ...
                positions.dedup();
                let sets: Vec<(i32, Vec<usize>)> = positions
                    .iter()
                    .map(|&pos| {
                        let nodes: Vec<usize> = pos_items
                            .iter()
                            .filter(|&&(p, _)| p == pos)
                            .map(|&(_, item)| item)
                            .collect();
    ...
    /* =========================================================
     * SECTION 4: Greedy algorithms (LEFT / RIGHT passes)
     * ========================================================= */
    ...
    /* =========================================================
     * SECTION 5: ILS State / helpers (from original solver)
     * ========================================================= */
    ...
    /* =========================================================
     * SECTION 6: Greedy constructors (ILS side)
     * ========================================================= */
            ...
            }
            {
                ...
                for &rm in &worst_used {
                    ...
                    for &c in &best_unused {
                        ...
                        let d = state.contrib[c]
                            - state.contrib[rm]
                            - state.ch.interaction_values[c][rm];
    ...
    /* =========================================================
     * SECTION 7: BP-seeded first iteration
     * ========================================================= */
    ...
    /* =========================================================
     * SECTION 8: ILS instance (unchanged from original)
     * ========================================================= */
    ...
    /* =========================================================
     * SECTION 9: Main Solver entry point
     * ========================================================= */
    ...
    impl Solver {
        pub fn solve(
            ...
            // --- Iteration 0: BP-seeded solution ---
            {
            ...
            // --- Iterations 1..n_restarts: ILS instances ---
