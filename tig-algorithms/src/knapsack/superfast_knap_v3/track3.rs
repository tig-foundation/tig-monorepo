        ...
        fn for_size(n: usize, budget: u32) -> Self {
            if n <= 1200 {
                if budget <= 5 {
                    ...
                    Self {
                        n_lambda_values: 1600,
                        n_random_starts: 5, n_crossover_gen: 12, sa_rounds: 30,
                        sa_iter: 313, n_sa_members: 3, ils_rounds: 333,
                        ils_restart_interval: 12, perturb_base_frac: 4,
                        perturb_max_frac: 5, ils_vnd_level: 0, bounded_2_2_k: 10,
                        n_full_restarts: 1, use_hub_pair: true,
                        use_heavy_polish: true, window_k: n, core_half_dp: 63,
                    }
                } else {
                    Self {
                        n_lambda_values: 1600,
                        n_random_starts: 4, n_crossover_gen: 26, sa_rounds: 15,
                        sa_iter: 470, n_sa_members: 8, ils_rounds: 50,
                        ils_restart_interval: 1, perturb_base_frac: 100,
                        perturb_max_frac: 28, ils_vnd_level: 0, bounded_2_2_k: 0,
                        n_full_restarts: 13, use_hub_pair: true,
