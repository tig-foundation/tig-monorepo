...
mod inner {
    ...
    pub fn run_bp_algorithm(inst: &P1Instance, n_lambda_values: usize) -> QKPResult {
        ...
        for bi in 0..inst.n_budgets {
            ...
            results.push(BudgetResult { budget: inst.budgets[bi], ofv, selected_items: best_items });
        }
        QKPResult { results }
    }
