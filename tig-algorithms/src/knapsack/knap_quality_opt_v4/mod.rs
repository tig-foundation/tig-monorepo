    ...
    pub fn solve(
        ...
        for restart in 0..n_phase3 {
            ...
            for round in 0..30 {
                ...
                perturb_by_strategy(&mut state, strength, stall, strategy, &mut rng, &hp);
        ...
        for lns_round in 0..8 {
            ...
            match lns_round % 4 {
                0 => greedy_reconstruct(&mut state, 0),
                1 => greedy_reconstruct(&mut state, 3),
                2 => {
                ...
                _ => greedy_reconstruct(&mut state, 2),
            }
