...
pub fn solve_challenge(
    ...
    match (n, budget_pct) {
        /* ---- n_items = 1000 ------------------------------------ */
        // all budgets
        (1000, 0..=5)       => track2::solve(challenge, save, hp),
        (1000, 6..=25)      => track5::solve(challenge, save, hp),
        (1000, _)            => track2::solve(challenge, save, hp),

        /* ---- n_items = 5000 ------------------------------------ */
        // all budgets
        (5000, _)            => track4::solve(challenge, save, hp),
