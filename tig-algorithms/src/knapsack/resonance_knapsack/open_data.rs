...
fn compute_solution(
    ...
    let base_iterations = if challenge.difficulty.num_items > 1000 {
        35  
    } else if challenge.difficulty.num_items > 500 {
        40  
    } else if challenge.difficulty.num_items > 200 {
        60  
    } else {
        80  
    };
...
fn solve_sub_instance(challenge: &SubInstance, base_iterations: i32) -> Result<Option<(SubSolution, i32)>> {
    let num_iterations = if challenge.difficulty.num_items > 1000 {
