    ...
    let result = match track {
        Track::FjspHigh => {
            let hp = merge_hp(hyperparameters, vec![
                ...
                ("fjsp_high_iters".into(), Value::Number(Number::from(7000u64))),
            ]);
        ...
        Track::HybridFlowShop => {
            let hp = merge_hp(hyperparameters, vec![
                ...
                ("hybrid_flow_shop_iters".into(), Value::Number(Number::from(1000u64))),
                ("hybrid_flow_shop_tabu_iters".into(), Value::Number(Number::from(60000u64))),
                ("hybrid_flow_shop_tabu_seeds".into(), Value::Number(Number::from(5u64))),
                ("hybrid_flow_shop_tabu_kick_swaps".into(), Value::Number(Number::from(3u64))),
                ("hybrid_flow_shop_tabu_stagnation".into(), Value::Number(Number::from(8000u64))),
                ("hybrid_flow_shop_ig_d".into(), Value::Number(Number::from(6u64))),
                ("hybrid_flow_shop_ig_mode".into(), Value::Number(Number::from(2u64))),
                ("hybrid_flow_shop_doe_mode".into(), Value::Number(Number::from(0u64))),
                ("hybrid_flow_shop_n8".into(), Value::Number(Number::from(0u64))),
                ("hybrid_flow_shop_bottleneck_reassign".into(), Value::Number(Number::from(0u64))),
            ]);
        ...
        Track::JobShop => {
            let hp = merge_hp(hyperparameters, vec![
                ...
                ("job_shop_iters".into(), Value::Number(Number::from(200000u64))),
            ]);
...
pub fn help() {
    println!("task_tree_h — per-track job scheduling solver");
}
