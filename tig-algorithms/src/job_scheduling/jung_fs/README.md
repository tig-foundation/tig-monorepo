...
|---|---:|---:|---:|
| n=50,s=fjsp_medium | 130,748 | 46.0% | 58 min |
| n=50,s=job_shop | 104,635 | 52.3% | 72 min |
| n=50,s=hybrid_flow_shop | 79,440 | 5.0% | 3 min |
| n=50,s=fjsp_high | 67,620 | 24.9% | 31 min |
| n=50,s=flow_shop | 18,001 | 0.9% | 2 min |
...
results. Verified additionally across two different host CPUs with per-nonce identical output.
