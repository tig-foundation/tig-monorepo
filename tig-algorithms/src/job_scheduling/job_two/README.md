...
### 3. Other
- Track-specialized solver with automatic instance detection
- NEH/Taillard/Iterated Greedy/VND for FlowShop, tabu search for JobShop, hybrid tabu for FjspMedium, bandit construction + critical block LS for HybridFlowShop and FjspHigh
