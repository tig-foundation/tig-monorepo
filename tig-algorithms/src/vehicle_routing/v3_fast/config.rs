...
impl Config {
    fn preset(exploration_level: usize, nb_nodes: usize) -> Self {
        ...
        match exploration_level {
            0 => Self {
                exploration_level: 0, allow_swap3: false, granularity: 20, granularity2: 10,
                penalty_tw: p, penalty_capa: p, target_ratio: 0.2,
                max_it_noimprov: 0, max_it_total: 0, nb_it_adapt_penalties: 100, nb_it_traces: 100,
            ...
            1 => Self {
                ...
                penalty_tw: p, penalty_capa: p, target_ratio: 0.2,
                max_it_noimprov: 0, max_it_total: 0, nb_it_adapt_penalties: 100, nb_it_traces: 100,
                mu: 2, mu_start: 4, lambda: 1, nb_close: 1, nb_elite: 1,
                max_ls_passes: 4,
            },
            2 => Self {
                exploration_level: 1, allow_swap3: false, granularity: 20, granularity2: 10,
                penalty_tw: p, penalty_capa: p, target_ratio: 0.2,
                max_it_noimprov: 10, max_it_total: 40, nb_it_adapt_penalties: 100, nb_it_traces: 100,
                mu: 3, mu_start: 5, lambda: 3, nb_close: 1, nb_elite: 1,
                max_ls_passes: 5,
            },
            3 => Self {
                exploration_level: 2, allow_swap3: false, granularity: 22, granularity2: 12,
                penalty_tw: p, penalty_capa: p, target_ratio: 0.2,
                max_it_noimprov: 100, max_it_total: 500, nb_it_adapt_penalties: 20, nb_it_traces: 20,
                mu: 5, mu_start: 8, lambda: 5, nb_close: 2, nb_elite: 2,
                max_ls_passes: 7,
            },
            4 => Self {
                exploration_level: 3, allow_swap3: false, granularity: 15, granularity2: 10,
                penalty_tw: p, penalty_capa: p, target_ratio: 0.2,
                max_it_noimprov: 4_000, max_it_total: 9_000, nb_it_adapt_penalties: 20, nb_it_traces: 100,
                mu: 10, mu_start: 14, lambda: 10, nb_close: 2, nb_elite: 3,
                max_ls_passes: 7,
            },
            5 => Self {
                exploration_level: 4, allow_swap3: false, granularity: 15, granularity2: 10,
                penalty_tw: p, penalty_capa: p, target_ratio: 0.2,
                max_it_noimprov: 7_000, max_it_total: 15_000, nb_it_adapt_penalties: 50, nb_it_traces: 200,
                mu: 12, mu_start: 16, lambda: 20, nb_close: 3, nb_elite: 4,
                max_ls_passes: 7,
            },
            6 => Self {
                exploration_level: 5, allow_swap3: false, granularity: 20, granularity2: 12,
                penalty_tw: p, penalty_capa: p, target_ratio: 0.2,
                max_it_noimprov: 20_000, max_it_total: 100_000, nb_it_adapt_penalties: 50, nb_it_traces: 500,
