...
use tig_challenges::vehicle_routing::{Challenge, Solution, SubInstance, SubSolution};
...
pub fn solve_sub_instance(instance: &SubInstance) -> anyhow::Result<Option<SubSolution>> {
