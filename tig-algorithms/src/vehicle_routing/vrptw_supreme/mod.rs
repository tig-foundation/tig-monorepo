        ...
        for i in 1..num_nodes {
            ...
            unsafe {
                ...
                for &(_d, j) in pool_vec.iter() {
                    ...
                    let time_compatibility =
                        (di_due - ri).min(dj - rj) as f32 / ((di_due - ri).max(dj - rj) + 1) as f32;
                ...
                for pos2_offset in 0..=1 {
                        ...
                        if target_route_demand + demands[node] <= max_capacity {
                            if let Some((best_pos, _delta_cost)) = find_best_insertion_in_route(
                                    ...
                                    && best_routes[route1_idx][pos1] == node
                                {
                                    ...
                                    let delta_remove =
                                        row_prev1[next1] - row_prev1[node] - row_node[next1];
                                    let delta_insert =
                                        row_prev2[node] + row_node[next2] - row_prev2[next2];
                                        ...
                                        && r2[r2.len() - 1] == 0
                                    {
                                        ...
                                        let new_d1 =
                                            utils::calculate_route_distance(&r1, distance_matrix);
                                        let new_d2 =
                                            utils::calculate_route_distance(&r2, distance_matrix);
                                        let new_distance =
                            ...
                            <= max_capacity
                    {
                            ...
                            && best_routes[route2_idx][pos2] == node2
                        {
                            ...
                            let delta1 = row_prev1[node2] + row_node2[next1]
                                - row_prev1[node]
                                - row_node[next1];
                            let delta2 = row_prev2[node] + row_node[next2]
                                - row_prev2[node2]
                                - row_node2[next2];
