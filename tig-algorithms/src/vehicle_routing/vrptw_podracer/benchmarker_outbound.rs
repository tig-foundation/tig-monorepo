...
mod simple_solver {
    ...
    pub fn solve_sub_instance_simple(
        ...
        while let Some(node) = nodes.pop() {
            ...
            let max_insertion_attempts = if num_nodes >= 2000 { 4 } else if num_nodes >= 1500 { 3 } else { 2 };
    ...
    fn do_local_searches(
        ...
        let max_total_iterations = if num_nodes >= 4000 { 110 } else if num_nodes >= 3500 { 95 } else if num_nodes >= 2500 { 80 } else if num_nodes >= 2000 { 65 } else if num_nodes >= 1500 { 50 } else { 45 };
