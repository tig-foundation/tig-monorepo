...
impl Config {
    fn preset(exploration_level: usize, nb_nodes: usize) -> Self {
        ...
        match exploration_level {
            0 => Self {
                exploration_level: 0, allow_swap3: true, granularity: 40, granularity2: 20,
            ...
            2 => Self {
                exploration_level: 1, allow_swap3: true, granularity: 40, granularity2: 20,
                penalty_tw: p, penalty_capa: p, target_ratio: 0.2,
                max_it_noimprov: 10, max_it_total: 50, nb_it_adapt_penalties: 100, nb_it_traces: 100,
                mu: 3, mu_start: 6, lambda: 3, nb_close: 1, nb_elite: 1,
            },
            3 => Self {
                exploration_level: 2, allow_swap3: true, granularity: 40, granularity2: 20,
                penalty_tw: p, penalty_capa: p, target_ratio: 0.2,
            ...
            4 => Self {
                ...
                penalty_tw: p, penalty_capa: p, target_ratio: 0.2,
                max_it_noimprov: 8_000, max_it_total: 16_000, nb_it_adapt_penalties: 20, nb_it_traces: 100,
                mu: 10, mu_start: 20, lambda: 10, nb_close: 2, nb_elite: 3,
            },
            5 => Self {
                exploration_level: 4, allow_swap3: false, granularity: 15, granularity2: 10,
                penalty_tw: p, penalty_capa: p, target_ratio: 0.2,
                max_it_noimprov: 12_000, max_it_total: 24_000, nb_it_adapt_penalties: 50, nb_it_traces: 200,
