...
extern "C" __global__ void reset_counters_100k(int *num_valid_moves, int *moves_executed) {
...
extern "C" __global__ void compute_refinement_moves_100k(
    const int num_nodes,
    const int num_parts,
    const int max_part_size,
    const int *node_hyperedges,
...
extern "C" __global__ void execute_refinement_moves_100k(
...
extern "C" __global__ void perturb_solution_100k(
    const int num_nodes,
    const int num_parts,
    const int max_part_size,
...
extern "C" __global__ void perturb_solution_targeted_100k(
    const int num_nodes,
    const int num_hyperedges,
    const int num_parts,
    const int max_part_size,
...
extern "C" __global__ void perturb_guided_100k(
