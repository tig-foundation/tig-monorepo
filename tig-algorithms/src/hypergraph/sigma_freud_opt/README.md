...
* **Algorithm Name:** sigma_freud_opt
...
freud_opt is an even further highly optimised and tuned hypergraph solver inspired by previous iterations. Huge performance increase for track 10k, ~50% reduction in runtime. Higher qualities on tracks 50k and 100k
