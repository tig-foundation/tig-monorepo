...
pub fn solve_challenge(
    ...
    match challenge.num_hyperedges {
        ...
        50000 => mod_b::solve_challenge(challenge, save_solution, hyperparameters, module, stream, prop),
        100000 => mod_a::solve_challenge(challenge, save_solution, hyperparameters, module, stream, prop),
...
pub fn help() {
    println!("hyper_opt_extrem_v6 - per-track GPU hypergraph partitioning");
}
