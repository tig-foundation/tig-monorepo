...
mod track_10k {
    ...
    pub fn config() -> TrackConfig {
        TrackConfig {
            ...
            stagnation_limit: 20,
            use_tiebreaker: true,
            init_swap_rounds1: 100,
            init_swap_rounds2: 50,
            ils_swap_rounds: 25,
        }
    }
}
...
mod track_200k {
    ...
    pub fn config() -> TrackConfig {
        TrackConfig {
            ...
            stagnation_limit: 20,
            use_tiebreaker: true,
            init_swap_rounds1: 150,
            init_swap_rounds2: 80,
            ils_swap_rounds: 25,
        }
    }
}
...
pub(crate) fn solve_core(
    ...
    let compute_moves_boundary_fn = module.load_function("compute_moves_boundary")?;
    ...
    macro_rules! refine {
        ...
        ($max_rounds:expr, $bw:expr, $mlimit:expr, $use_tabu:expr, $use_adaptive:expr, $quick:expr, $cap_aware:expr, $init_temp:expr) => {{
            ...
            let use_boundary_base = n_hedges <= 200000;
            ...
            for round in 0..$max_rounds {
                ...
                } else { stagnant = 0; if (me as usize) < n / 2000 { low_move_streak += 1; } else { low_move_streak = 0; } if low_move_streak >= 8 && !quick { break; } }
            }
        }};
    }
    ...
    for ils_iter in 0..ils_iters {
        ...
        if tc.use_gpu_swaps { gpu_swap_phase!(tc.ils_swap_rounds, true); }
        ...
        if ils_iter > 0 && ils_iter % 15 == 0 {
            cur_conn = best_conn; cur_partition.copy_from_slice(&best_partition); cur_nip.copy_from_slice(&best_nip);
        } else {
