...
pub fn solve(
    ...
    let bok_runs = hyperparameters
        ...
        .map(|v| v.clamp(1, 23) as usize) // K_max=14: measured fuel-safe max
        .unwrap_or(1); // default 1 => byte-identical to pre-port behavior
    ...
    let overlay_enabled = hyperparameters
        ...
        .unwrap_or(0) // overlay OFF by default (default byte-identical)
        != 0;
    ...
    for bok_run in 0..bok_runs {
        ...
        // run 0 => offset 0 => byte-identical to pre-port behavior.
