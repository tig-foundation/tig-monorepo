...
pub fn help() {
    println!("sat_tailwalk_v3: track-routed tail-aware local-search SAT solver for TIG c001.");
...
fn save_if_solved(
    ...
    anyhow::bail!("sat_tailwalk_v3 normalized solution failed original challenge validation")
}
