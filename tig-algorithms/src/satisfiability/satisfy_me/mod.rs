...
pub fn solve_challenge(
    ...
    let mut pos_single = vec![false; challenge.num_variables];
    let mut neg_single = vec![false; challenge.num_variables];
    ...
    let total_variables = challenge.num_variables;
    ...
    let clauses_to_vars_ratio = (challenge.clauses.len() * 100 / challenge.num_variables) as f64;
    let total_vars = challenge.num_variables as f64;
    ...
    let _ = save_solution(&Solution { variables: solution_variables });
    return Ok(());
}
