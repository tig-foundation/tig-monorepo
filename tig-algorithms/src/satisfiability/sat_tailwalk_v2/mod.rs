...
pub fn help() {
    println!("sat_tailwalk_v2: tail-aware focused local-search SAT solver for TIG c001.");
...
fn save_if_solved(
    ...
    anyhow::bail!("sat_tailwalk_v2 normalized solution failed original challenge validation")
}
