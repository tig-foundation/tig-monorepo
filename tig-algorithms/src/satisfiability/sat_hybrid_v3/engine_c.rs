// SAT solver engine C — self-contained per-track SAT engine.
...
pub fn solve(
    ...
    // solver lookup table: round(2048 * (0.9 + b)^(-2.06)) for b in 0..16
    ...
    unsafe {
        loop {
            ...
            let v_idx = if zero_cnt > 0 {
                ...
                // solver weighted selection: pick var proportional to (0.9 + break)^-2.06
