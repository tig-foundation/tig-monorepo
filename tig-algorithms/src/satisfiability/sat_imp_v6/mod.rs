...
pub struct Hyperparameters {
    ...
    pub restart_attempts: Option<usize>,    
    pub extra_attempts: Option<usize>,   
    pub abandon_checkpoints_mflips: Option<Vec<f64>>,
    pub abandon_thresholds: Option<Vec<usize>>,
}

pub fn help() {
    println!("SAT imp v5 - per-track files (track1/track2/track3/track4/track5)");
    println!("Faster runtimes by over 50% on some tracks, equal or higher quality than sat_hybrid_v4");
}
