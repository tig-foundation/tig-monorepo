...
LLVM_RELEASES=(
    "https://github.com/tig-foundation/llvm/releases/download/aarch64.rc1-19.1.7/llvm.tar.zst"
)

LLVM_CHECKSUMS=(
    "2e333e0d9ed59671ef67f41d8990f314bbad65060afbdccf4701fc9e5cc21707"
)
